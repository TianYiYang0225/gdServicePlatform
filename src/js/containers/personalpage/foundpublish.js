...
class FoundPublish extends React.Component {
    static contextTypes = {
...
const WrappedFoundPublish = Form.create()(FoundPublish);
export default WrappedFoundPublish;