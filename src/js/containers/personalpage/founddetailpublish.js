...
class FounddetailPublish extends React.Component {
    static contextTypes = {
    ...
    render() {
        ...
        return (
            <div className="foudn_detail_wrap">
                ...
                <Form onSubmit={this.handleSubmit} type="flex" className="from_style">
                    <FormItem
...
const WrappedFounddetailPublish = Form.create()(FounddetailPublish);
export default WrappedFounddetailPublish;