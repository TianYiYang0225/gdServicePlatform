...
class LostRow extends React.Component {
    static contextTypes = {
    ...
    render() {
        ...
        return (
            <div className="found_row" onClick={this.foundrowClick.bind(this)} data-key="234">
                <div className="found_row_left">
                    <img className="list_img_style" src={list_picture}/>
                </div>
